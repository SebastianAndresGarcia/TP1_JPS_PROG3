...
<body>
	<form class="form-register">
		Legajo<br> <input type="number" class="controls" id="legajo"
			name="legajo" /><br> Nombre del empleado<br> <input
			type="text" class="controls" id="nombre" name="nombre" /><br>
		Codigo de Bono de Sueldo<br> <input type="text" class="controls"
			id="codBono" name="codBono" /><br>
		<br> <select id="mes" name="mes">
		...
		</select> <br>Anio<br> <input type="number" class="controls"
			id="anio" name="anio" /><br> Total<br> <input
			type="number" class="controls" id="total" name="total" /><br>
		<br> <input type="button" class="controls" value="enviar"
			onclick="cargarDatos()"><br>
	</form>
	<br>
	<table id="Tabla" border="1" class="tabla1">
		<br>
		<tr class="head">
			<th>Legajo</th>
			<th>Empleado</th>
