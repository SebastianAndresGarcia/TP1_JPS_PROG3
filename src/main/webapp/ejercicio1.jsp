...
<html>
    ...
    <body>
        <h1>EJERCICIO 1</h1>
        <form action="tabla.jsp"><br>
            Ingrese el numero de filas<br>
            <input type="text" name="filas" id="filas" /><br><br>
            Ingrese el numero de columnas<br>
            <input type="text" name="columnas" id="columnas" /><br><br>
